...
The project uses Windows Security Event ID **4625**, which represents a failed logon attempt, to identify suspicious authentication activity.
...
3. Search for failed login events using Event ID 4625.
...
Event ID 4625 by itself does not prove that an attack occurred. The events should be correlated with source IP addresses, usernames, timestamps, frequency, and other available security information.
